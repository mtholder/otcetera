...
void mapNextTree(const Tree_t& summaryTree,
    ...
    auto ottid_to_node = get_ottid_to_const_node_map(tree);
    {
        ...
        perform_conflict_analysis2(tree, ottid_to_node, mrca_of_pair,
    ...
    }
    {
        ...
        auto log_attachment_points = [](const vector<const node_t*>&, const node_t*) {};

        perform_conflict_analysis2(summaryTree, constSummaryOttIdToNode, mrca_of_pair,
